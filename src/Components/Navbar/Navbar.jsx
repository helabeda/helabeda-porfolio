  ...
  return (
    ...
    >
      <div>
        ...
        <span className='py-3 px-6 font-bold text-sm border border-transparent rounded-lg
         '>
          {""}
        </span>
        {toggle && (
        <motion.div 
          ...
          className='fixed h-full w-96 top-0 left-0 z-20
        bg-Teal text-white flex flex-col justify-center items-center
